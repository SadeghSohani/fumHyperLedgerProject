...
const queryChickensByOwner = async (channelName, chaincodeName, username, org_name, owner) => {
    ...
    try {
        ...
        result = await contract.evaluateTransaction("queryChickensByOwner", owner);
...
const getHistoryForChicken = async (channelName, chaincodeName, username, org_name, chickenId) => {
    ...
    try {
        ...
        // Query on smart contract.
        result = await contract.evaluateTransaction("getHistoryForAsset", chickenId);
...
const queryAllChickens = async (channelName, chaincodeName, username, org_name) => {
    ...
    try {
        ...
        // Query on smart contract.
        result = await contract.evaluateTransaction("queryAllChickens");
...
const queryPublicChickens = async (channelName, chaincodeName, username, org_name) => {
    ...
    try {
        ...
        // Query on smart contract.
        result = await contract.evaluateTransaction("queryPublicChickens");
